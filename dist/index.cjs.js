...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#F4F4F9", backgroundDisabled: "#E8E9EB", backgroundAlt: "#FFFFFF", cardBorder: "#E9EAEB", contrast: "#191325", dropdown: "#F4F4F9", dropdownDeep: "#E2E6ED", invertedContrast: "#FFFFFF", input: "#DFE7F2", inputSecondary: "#DFE7F2", tertiary: "#DEFFFE", text: "#b5b9c7", textDisabled: "#BDC2C4", textSubtle: "#6A93AD", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9AEBED", background: "#17172d", backgroundDisabled: "#3c3742", backgroundAlt: "#030323", cardBorder: "#38434C", contrast: "#191326", dropdown: "#1B1E1E", dropdownDeep: "#0E1214", invertedContrast: "#191326", input: "#3B3F56", inputSecondary: "#222B51", primaryDark: "#e3e1e1", tertiary: "#353547", text: "#E1E7F9", textDisabled: "#BDC2C4", textSubtle: "#B9CEEA", disabled: "#4A5160", gradients: {
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React__default['default'].createElement(MenuLink, { target: "_blank", rel: "noreferrer", href: item.href },
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://info.quickswap.exchange/token/0x782eb3304F8b9adD877F13a5cA321f72c4AA9804", target: "_blank" },
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(Icon$16, { color: "textSubtle", width: "24px" }) },
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React__default['default'].createElement("a", { target: "_blank", rel: "noreferrer", href: "https://rugdoc.io/project/platinum-finance/" },
...
exports.PresentCheckIcon = Icon$J;
exports.PresentNoneIcon = Icon$H;
exports.PresentWonIcon = Icon$I;
exports.PrizeIcon = Icon$P;
exports.Progress = Progress;
exports.ProgressBunny = Icon$L;
exports.ProposalIcon = Icon$O;
exports.Radio = Radio;
exports.RefreshIcon = Icon$o;
exports.RemoveIcon = Icon$N;
exports.ResetCSS = ResetCSS;
exports.SearchIcon = Icon$z;
exports.Skeleton = Skeleton;
exports.Slider = Slider;
exports.Spinner = Spinner;
exports.StarFillIcon = Icon$y;
exports.StarLineIcon = Icon$x;
exports.Step = Step;
